...
#define LOWEST_ALLOWABLE_VOLTAGE 3.3 //Kehinde: 3.8, 3.4//5v Power is lost when battery level reaches 3v, step up chip no longer functions  //3.3 too low
#define CHARGED_VOLTAGE 4.1 //3.8 // 3.65 appears to be the max voltage  //3.79 was too high

////////////////////////////////////////////// Pitch Servo Parameters //////////////////////////////////////////////
#define LOW_ROW_ANGLE   45 //45, JSP  //pitch servo is commanded to point toward ground
...
#define OPEN_POS 120//90, JSP     //grip servo fully open angle
#define MID_POS 80 //JSP //grip servo half-open angle
...
#define OUT_DIRECTION 					285 //255 // Ross 11/15 -> 270 -> 287 //240//291//300 // previously set to 270-  //modified
#define IN_DIRECTION  					65 //90 // Ross 11/16 90 -> 25 //89//30 //  used to be 60  //Ross10/11 90->290
// #define GET_BACK_DIRECTION 			25 //compass direction
// #define CHARGING_DIRECTION 			240//240//300 //170 is at the wall, towards me
#define DIRECTION_UNCERTAINTY 	30 //60 //used to be 5. increased to 10
...
////////////////////////////////////////////// IMU Bias Parameters //////////////////////////////////////////////
#define HX_MIN -0.27 //-0.24 //-0.3400
#define HX_MAX 0.2 //0.06 //0.0100

#define HY_MIN -0.04 //-0.07 //-0.0500
#define HY_MAX 0.22 //0.2400
...
#define BASE_SPEED 180 //200 //worked okay with 100
